...
namespace JobManagement.WebMvc.Controllers
{
    ...
    public class JobsController : Controller
    {
        ...
        {
            JobManagement.WebMvc.Models.Jobs.JobsWorkJournalModel model = new Models.Jobs.JobsWorkJournalModel();
            ...
            if (filterPeopleId.HasValue)
            {
                ...
                {
                    p = DataAccessLayer.DBPeople.getOne(filterPeopleId.Value);
                }
            }
            else
            {
        ...
        [OutputCache(Duration = 0, VaryByParam = "none", NoStore = true)]
        public ActionResult ModalEditNoWorkHour()
        {
            Models.ModalEditNoWorkHour model = new Models.ModalEditNoWorkHour();
            model.LoadData(this.User.Identity.GetPeople().PeopleId);
            return PartialView(model);
        }
    }
}   
