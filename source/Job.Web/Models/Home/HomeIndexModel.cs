...
namespace Job.WebMvc.Models.Home
{
    public class HomeIndexModel
    {
        ...
        public void LoadModelData(int peopleId, int monthYear)
        {
            EFDataModel.Person per = DataAccessLayer.DBPerson.getOne(peopleId);
            this.ResourceId = per.IdentityId;
            this.PeopleId = per.PeopleId;
            int a = monthYear / 100;
            int m = monthYear % 100;
            LoadMonthWork(a,m,per);
            ...
            this.DDLPerson = DataAccessLayer.DBPerson.getDDLPerson(this.LoggedUser.Id);
        }
        
        private void LoadMonthWork(int a, int m, EFDataModel.Person per) {
            ...
            foreach (EFDataModel.upOreMensiliLavorateGiornaliero_Result g in giorni)
            {
                ...
                switch (currentDate.DayOfWeek)
                {
                    case DayOfWeek.Monday:
                        ...
                        s.Lunedi.Ordinario = (per.MondayExpectedHours.HasValue ? per.MondayExpectedHours.Value : decimal.Zero);
                    ...
                    case DayOfWeek.Tuesday:
                        ...
                        s.Martedi.Ordinario = (per.TuesdayExpectedHours.HasValue ? per.TuesdayExpectedHours.Value : decimal.Zero);
                        if (currentDate.AddDays(1).Month != currentDate.Month)
                        {
                            LavoroDelMese.Add(s);
                        }
                    ...
                    case DayOfWeek.Wednesday:
                        ...
                        s.Mercoledi.Ordinario = (per.WendsdayExpectedHours.HasValue ? per.WendsdayExpectedHours.Value : decimal.Zero);
                        if (currentDate.AddDays(1).Month != currentDate.Month)
                        {
                            LavoroDelMese.Add(s);
                        }
                    ...
                    case DayOfWeek.Thursday:
                        ...
                        s.Giovedi.Ordinario = (per.ThursdayExpectedHours.HasValue ? per.ThursdayExpectedHours.Value : decimal.Zero);
                        if (currentDate.AddDays(1).Month != currentDate.Month)
                        {
                            LavoroDelMese.Add(s);
                        }
                    ...
                    case DayOfWeek.Friday:
                        ...
                        s.Venerdi.Ordinario = (per.FridayExpectedHours.HasValue ? per.FridayExpectedHours.Value : decimal.Zero);
                        if (currentDate.AddDays(1).Month != currentDate.Month)
                        {
                            LavoroDelMese.Add(s);
                        }
                    ...
                    case DayOfWeek.Saturday:
                        ...
                        s.Sabato.Ordinario = (per.SaturdayExpectedHours.HasValue ? per.SaturdayExpectedHours.Value : decimal.Zero);
                        if (currentDate.AddDays(1).Month != currentDate.Month)
                        {
                            LavoroDelMese.Add(s);
                        }
                    ...
                    case DayOfWeek.Sunday:
                        ...
                        s.Domenica.Ordinario = (per.SundayExpectedHours.HasValue ? per.SundayExpectedHours.Value : decimal.Zero);
                        LavoroDelMese.Add(s);
                        s = new Settimana();
                        break;
                }
